  ...
  return (
    <Drawer sx={styles.drawer} open={isOpen} onClose={() => setOpen(false)}>
      ...
      <List sx={styles.navList}>
        <ListItemLink to="/RNAs" primary="View RNAs" icon={<RNAList />} />
        <Divider />
        <ListItemLink to="/" primary="Insights" icon={<AnalyticsIcon />} />
        <Divider />
        <ListItemLink
          to="/"
        ...
        <Divider />
        {user && (
          <ListItemLink to="/update-personal-details" primary="Personal Details" icon={<InfoIcon />} />
        )}
        <Divider />
        <ListItemLink
          to="/"
